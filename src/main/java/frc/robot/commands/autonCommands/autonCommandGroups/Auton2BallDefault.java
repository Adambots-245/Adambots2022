...
public class Auton2BallDefault extends SequentialCommandGroup{
    ...
    public Auton2BallDefault(DriveTrainSubsystem driveTrain, IntakeSubsystem intakeSubsystem, CatapultSubsystem catapultSubsystem) { 
        super(
